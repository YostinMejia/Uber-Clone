export class Travel {
    ...
    async startTravel(markersList) {
        ...
        document.getElementById("distance").innerText = "Distance (Km):" + this.distance
        document.getElementById("duration").innerText = "Duration (minutes):" + this.duration
        document.getElementById("price").innerText = "precio (pesos):" + this.price
    }
